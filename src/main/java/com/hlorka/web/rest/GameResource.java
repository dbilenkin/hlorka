...
import com.hlorka.repository.GameRepository;
...
public class GameResource {
    ...
    @Timed
    public ResponseEntity<Game> joinGame(@PathVariable Long id) throws URISyntaxException {
        ...
        Game result = gameRepository.save(game);
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityJoinAlert(user.getFirstName(), game.getName(), game.getId().toString()))
            .body(result);
    }
    ...
    public List<Game> getAllGames() {
        ...
        List<Game> games = gameRepository.findAllWithEagerRelationships();
        return games;
    }
