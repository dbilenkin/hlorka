...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "hlorka@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "hlorka API";

        private String description = "hlorka API documentation";
